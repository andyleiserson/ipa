    ...
    let result: Vec<_> = if config.per_user_credit_cap == 256 {
        ...
        world.semi_honest(
            ...
            |ctx, input_rows: Vec<OPRFIPAInputRow<BA5, BA8, BA20>>| async move {
                oprf_ipa::<_, BA5, BA8, BA32, BA20, 8, 32>(ctx, input_rows, aws, dp_params)
                    .await
                    .unwrap()
            },
        )
        ...
        world.semi_honest(
            ...
            |ctx, input_rows: Vec<OPRFIPAInputRow<BA8, BA3, BA20>>| async move {
                ...
                match config.per_user_credit_cap {
                    8 => oprf_ipa::<_, BA8, BA3, BA32, BA20, 3, 256>(ctx, input_rows, aws, dp_params)
                    .await
                    .unwrap(),
                    16 => oprf_ipa::<_, BA8, BA3, BA32, BA20, 4, 256>(ctx, input_rows, aws, dp_params)
                    .await
                    .unwrap(),
                    32 => oprf_ipa::<_, BA8, BA3, BA32, BA20, 5, 256>(ctx, input_rows, aws, dp_params)
                    .await
                    .unwrap(),
                    64 => oprf_ipa::<_, BA8, BA3, BA32, BA20, 6, 256>(ctx, input_rows, aws, dp_params)
                    .await
                    .unwrap(),
                    128 => oprf_ipa::<_, BA8, BA3, BA32, BA20, 7, 256>(ctx, input_rows, aws, dp_params)
                    .await
                    .unwrap(),
                    _ =>
                    panic!(
